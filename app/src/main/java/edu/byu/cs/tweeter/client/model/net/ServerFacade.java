...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://ebkh8rex5d.execute-api.us-west-2.amazonaws.com/tweeter-deployed-stage";
     ...
     * @return the statuses.
     */
    public GetStatusesResponse getStory(PagedRequest<Status> request, String urlPath)
            throws IOException, TweeterRemoteException {
        System.out.println("ServerFacade#getStory with URL=" + urlPath);
        GetStatusesResponse response = clientCommunicator.doPost(urlPath, request, null, GetStatusesResponse.class);
        return response;
    }
     ...
     */
    public GetUsersResponse getFollowing(PagedRequest<User> request, String urlPath)
            throws IOException, TweeterRemoteException {
        GetUsersResponse response = clientCommunicator.doPost(urlPath, request, null, GetUsersResponse.class);
        return response;
    }
     ...
     */
    public GetCountResponse getFollowingCount(GetFollowingCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
     ...
     */
    public GetUsersResponse getFollowers(PagedRequest<User> request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, GetUsersResponse.class);
    }
     ...
     */
    public GetCountResponse getFollowersCount(GetFollowersCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, GetCountResponse.class);
    }
     ...
     */
    public GetStatusesResponse getFeed(PagedRequest<Status> getFeedRequest, String urlPath)
            throws IOException, TweeterRemoteException {
        System.out.println("ServerFacade#getFeed with URL=" + urlPath);
        GetStatusesResponse response = clientCommunicator.doPost(urlPath, getFeedRequest, null, GetStatusesResponse.class);
        return response;
    }
}
