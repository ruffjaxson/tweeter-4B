 ...
 */
public class GetStoryHandler extends PagedServerHandler<Status> implements RequestHandler<PagedRequest<Status>, PagedResponse> {
    @Override
    public PagedResponse<Status> handleRequest(PagedRequest<Status> pagedRequest, Context context) {
        ...
        PagedResponse<Status> response = statusService.getStory(pagedRequest);
